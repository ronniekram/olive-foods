  ...
  return (
    <>
      ...
      <TwoCol
        ...
        text={[
          `It has the power to connect people from all walks of life and corners of the world. It is a fundamental part of human culture, and it has been for thousands of years.`,
      ...
      <div tw="bg-green-100 text-green-500 pt-5 pb-10 md:(pt-10 pb-14) xl:(pt-4 pb-20)">
        <Wrapper>
          ...
          <div tw="flex flex-col space-y-4 md:(pr-10 w-[60%]) lg:(pr-14 w-[50%]) xl:(space-y-6 pr-16)">
            <p>
              Food has a remarkable ability to unite people, bridge cultural divides, and create a
              sense of community. It allows us to celebrate our differences and find common ground.
              Sharing food is not just about a meal, but also about sharing our stories, traditions,
              and values with others.
            </p>
            <p>
              The belief that food nourishes both body and soul is rooted in the idea that it's not
              just fuel, but a source of comfort, joy, and creative expression. It enables us to
              explore new flavors, cuisines, and cultures, and enjoy the pleasures of the table.
            </p>
          </div>
        </Wrapper>
      </div>
